...
<div class="container px-6 mx-auto grid">
    <div class="grid grid-cols-6">
        <h2 class="col-span-6 md:col-span-3 my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            {{$titulo}}
            <a href="{{route('empleados.created')}}"
            ...
            <table class="w-full whitespace-no-wrap display">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-sm text-center no-export">
                            <a href ="{{route('empleados.edit',$value)}}"  style=" border: none;" class="p-2 focus:outline-none focus:shadow-outline-gray editar text-sm font-medium leading-5 text-gray-700 hover:text-gray-900 transition-colors duration-150 dark:text-gray-400 rounded"><i class="fas fa-edit"></i></a>
                            
                            {!! Form::open(['route' => ['empleados.destroy', $value], 'method' => 'delete']) !!}
                            @csrf
